...
internal class ToolbarStartFromFirstScene : BaseToolbarElement {
	...
	public override void Init() {
		...
		startFromFirstSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SC KRM/CustomToolbar/Editor/Icons/LookDevSingle1@2x.png", typeof(Texture2D)), "Start from 1 scene");
	}
