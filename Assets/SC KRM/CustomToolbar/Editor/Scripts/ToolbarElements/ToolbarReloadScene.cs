...
internal class ToolbarReloadScene : BaseToolbarElement {
	...
	public override void Init() {
		reloadSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SC KRM/CustomToolbar/Editor/Icons/LookDevResetEnv@2x.png", typeof(Texture2D)), "Reload scene");
	}
