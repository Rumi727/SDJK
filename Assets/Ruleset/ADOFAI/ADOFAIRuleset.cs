...
namespace SDJK.Ruleset.ADOFAI
{
    public sealed class ADOFAIRuleset : RulesetBase
    {
        ...
        public override void GameStart(string mapFilePath, string replayFilePath, bool isEditor, IMode[] modes) => MessageBoxManager.Show("sc-krm:gui.ok", 0, "sdjk:ruleset.adofai.unplayable", "sc-krm:0:gui/icon/exclamation_mark").Forget();
    }
}
